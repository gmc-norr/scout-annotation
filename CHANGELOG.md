...
## [1.0.0](https://github.com/gmc-norr/scout-annotation/compare/scout-annotation-v0.8.0...scout-annotation-v1.0.0) (2026-04-23)
...
* add a cli for running the pipeline ([52434e6](https://github.com/gmc-norr/scout-annotation/commit/52434e66530f9c03b5b4418318a18141dab8d5b4))
...
* add bam file to load config ([fef6c54](https://github.com/gmc-norr/scout-annotation/commit/fef6c54fdb22cf966409348a5edfd5a7d573aef7))
...
* add batch command to cli ([921f2eb](https://github.com/gmc-norr/scout-annotation/commit/921f2eb09f43323bc3eb5af8f44a34dc7003e919))
* add batch command to cli ([6ecfdc9](https://github.com/gmc-norr/scout-annotation/commit/6ecfdc943eadcc0ba4ecceab7d774e81a5341a66))
* add batch command to cli ([cfc5c56](https://github.com/gmc-norr/scout-annotation/commit/cfc5c564d7cfad8fb6fa6d63d84f19b3cdbcb124))
* add batch command to cli ([d5ecc77](https://github.com/gmc-norr/scout-annotation/commit/d5ecc7773c28f8a0c27f661e78a32db1df67bdd8))
* add batch command to cli ([a160595](https://github.com/gmc-norr/scout-annotation/commit/a160595d9a63434ebdc4f36dff1fe1e06db0d6ca))
* add batch command to cli ([0f944c0](https://github.com/gmc-norr/scout-annotation/commit/0f944c020903e0824fb9411fcf0b8c1b3a0803bc))
* add batch command to cli ([f7a5b08](https://github.com/gmc-norr/scout-annotation/commit/f7a5b08c9f5ca8c201a5366216506f412e3054fa))
* add batch command to cli ([7dd1960](https://github.com/gmc-norr/scout-annotation/commit/7dd1960d5301e24408bd0bc4a9a91e29025ed209))
* add case owner to load config ([27bff50](https://github.com/gmc-norr/scout-annotation/commit/27bff504d1d52ce476e282d9aa07b10f587eed1f))
...
* add rank score threshold to load config ([3945330](https://github.com/gmc-norr/scout-annotation/commit/3945330196e178edce07de16cd0144e14b06ed64))
...
* add SNV filtering capability ([b8a82e7](https://github.com/gmc-norr/scout-annotation/commit/b8a82e7293f9259af7a5905dc3b28e26b7ecec33))
...
* filter VCFs with in silico gene panels ([345ae7f](https://github.com/gmc-norr/scout-annotation/commit/345ae7f7649af30f527ef17d315b62f726073558))
* filtering fixes ([e5caa69](https://github.com/gmc-norr/scout-annotation/commit/e5caa6929a8c8caf05853dbe4db7de99a5f7f16e))
* fix rank score sample names ([9555335](https://github.com/gmc-norr/scout-annotation/commit/955533576f4ee1a454f56573fc5e3fa6393e39b4))
...
* remove duplicate variants ([2a2a2df](https://github.com/gmc-norr/scout-annotation/commit/2a2a2df4272094c8e88f8df828dcce4fffe71178))
...
* use panel dir in working directory, if found ([5f953fe](https://github.com/gmc-norr/scout-annotation/commit/5f953feaa4c9b7f67ba4d19f72c68b3d2cdf217d))
...
* correctly set AF for variants ([f4d3fb7](https://github.com/gmc-norr/scout-annotation/commit/f4d3fb75f09568c19285eb87bc09f5b28eadb91b))
...
* get version from command line ([ba10168](https://github.com/gmc-norr/scout-annotation/commit/ba10168bf2d172bf32278af4007ff53d81e1d93c))
...
* issue where a defined AF was set to missing ([17b892b](https://github.com/gmc-norr/scout-annotation/commit/17b892b937608437691456bb76a6c4fb426a4bfb))
...
* issue where original sample name ended up in load config ([2fce448](https://github.com/gmc-norr/scout-annotation/commit/2fce4483cca2dbbf004b6424c2371d0dda34f518))
...
* relative path not correctly resolved ([8affaff](https://github.com/gmc-norr/scout-annotation/commit/8affaff88ee3ec4fc43f5e279759fb51e84d6260))
...
* sort before uniq and better decompose ([6d94d99](https://github.com/gmc-norr/scout-annotation/commit/6d94d9985609b4f357150f793bb7231bd2925117))
...
* symlink BAM files using absolute paths ([2f118c1](https://github.com/gmc-norr/scout-annotation/commit/2f118c16727f8268767b3571e6a7c94deb0f135a))
