...
rule vt_sort:
    ...
    output:
        vcf=temp(
            f"{decompose_dir}/{{family}}/{{family}}.decomposed.normalized.sort.vcf"
        ),
    log:
...
rule vt_uniq:
    ...
    output:
        vcf=temp(
            f"{decompose_dir}/{{family}}/{{family}}.decomposed.normalized.uniq.vcf"
        ),
    log:
...
rule fix_vcf_af:
    ...
    output:
        vcf=temp(
            f"{decompose_dir}/{{family}}/{{family}}.decomposed.normalized.uniq.fix-af.vcf"
        ),
    log:
...
rule bgzip_normalized:
    ...
    output:
        vcfgz=temp(
            f"{decompose_dir}/{{family}}/{{family}}.decomposed.normalized.uniq.fix-af.vcf.gz"
        ),
    log:
...
rule tabix_normalized:
    ...
    output:
        tabix=temp(
            f"{decompose_dir}/{{family}}/{{family}}.decomposed.normalized.uniq.fix-af.vcf.gz.tbi"
        ),
    log:
